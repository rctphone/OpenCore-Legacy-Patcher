...
class MainFrame(wx.Frame):
    ...
    def _generate_elements(self) -> None:
        ...
        # Title label: OpenCore Legacy Patcher v{X.Y.Z}
        title_label = wx.StaticText(self, label=f"OpenCore Legacy Patcher {self.constants.patcher_display_version}", pos=(-1, 10))
...
Please check the Github page for more information about this release."""
        ...
        self.description = wx.StaticText(panel, label=f"OpenCore Legacy Patcher {oclp_version} is now available - You have {self.constants.patcher_display_version}. Would you like to update?")
